...
export class Card extends Component<ICard>{
  ...
  constructor(protected container: HTMLTemplateElement, actions?: ICardActions) {
    super(container);
  ...
  */
  ...
  set price(price: number | null) {
    ...
    if (price === null && this.cardButton && !this.cardButton.classList.contains('basket__item-delete')){
  ...
  set button(value: string) {
    if (this.cardButton && !this.cardButton.classList.contains('basket__item-delete')) {
